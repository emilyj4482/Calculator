...
private extension ButtonTapService {
    ...
    func replaceLastest(_ text: String) {
        var currentText = textPublisher.value
        currentText.removeLast()
        textPublisher.send(currentText + text)
    }
    
    func replaceLastTwo(_ text: String) {
        var currentText = textPublisher.value
        currentText.removeLast(2)
        textPublisher.send(currentText + text)
    }
    
    func updateButtonTapHistory(_ buttonInfo: ButtonInfo) {
...
private extension ButtonTapService {
    func numberButtonTapped(of buttonInfo: ButtonInfo) {
    ...
    func operationButtonTapped(of buttonInfo: ButtonInfo) {
    ...
    func completerButtonTapped(of buttonInfo: ButtonInfo) {
